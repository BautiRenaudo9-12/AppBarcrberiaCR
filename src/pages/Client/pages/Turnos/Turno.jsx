...
export const Turno = ({ stateComplete, state, reserveId, isAdmin, time, modalConfirmTurnoModal, reserveInfoAdmin, turnoStateModal, pickUpDate }) => {
    ...
    const handleClick = () => {
        ...
        if (isAdmin) {
            reserveInfoAdmin.openModal()
            reserveInfoAdmin.setInfo({
        ...
        <li className="turno">
            ...
            <div className="elements-div">
                    ...
                    onClick={handleClick}>RESERVAR</button>
                {
                    isAdmin &&
                    <>
                        <ToggleSwitches pickUpDate={_time} stateComplete={stateComplete} state={state} turnoStateModal={turnoStateModal} reserveId={reserveId} />
